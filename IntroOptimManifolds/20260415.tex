...
\myBox{Smoothness}{
    ...
    \end{gather*}
    It is known that smoothness is equivalent to the existence and continuity of the $k$-th Fr\'echet derivatives:
    \begin{gather*}
        (U \subseteq \mathbb{R}^d \text{ is open}, \quad f\colon U \to \mathbb{R}, \quad k \in \mathbb{N})\\
        f \text{ is of class } C^k \text{ on } U\\
        \iff\\
...
\myBox{Exercise 3.41}{\\
    ...
    \begin{gather*}
        ...
        \mathrm{T}_x \mathcal{N} = \ker(\mathrm{D} g(x)) \subset \mathrm{T}_x \mathcal{M}.
    \end{gather*}
    \vskip\baselineskip
